...
function dom7_esm_getPrototypeOf(o) {
  dom7_esm_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {
    return o.__proto__ || Object.getPrototypeOf(o);
  };
  return dom7_esm_getPrototypeOf(o);
}

function dom7_esm_setPrototypeOf(o, p) {
  dom7_esm_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {
    o.__proto__ = p;
    return o;
  };

  return dom7_esm_setPrototypeOf(o, p);
}

function dom7_esm_isNativeReflectConstruct() {
  if (typeof Reflect === "undefined" || !Reflect.construct) return false;
  if (Reflect.construct.sham) return false;
  if (typeof Proxy === "function") return true;
...
function _construct(Parent, args, Class) {
  if (dom7_esm_isNativeReflectConstruct()) {
    ...
    _construct = function _construct(Parent, args, Class) {
      ...
      if (Class) dom7_esm_setPrototypeOf(instance, Class.prototype);
      return instance;
    };
  }
...
function _wrapNativeSuper(Class) {
  ...
  _wrapNativeSuper = function _wrapNativeSuper(Class) {
    ...
    function Wrapper() {
      return _construct(Class, arguments, dom7_esm_getPrototypeOf(this).constructor);
    }
    ...
    return dom7_esm_setPrototypeOf(Wrapper, Class);
  };

  return _wrapNativeSuper(Class);
}

function dom7_esm_assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
...
var Dom7 = /*#__PURE__*/function (_Array) {
  ...
  function Dom7(items) {
    ...
    makeReactive(dom7_esm_assertThisInitialized(_this));
    return _this;
  }
...
var Zoom = {
  ...
  onTouchMove: function onTouchMove(e) {
    ...
    if (!image.isMoved) {
      ...
      image.startX = utils_getTranslate(gesture.$imageWrapEl[0], 'x') || 0;
      image.startY = utils_getTranslate(gesture.$imageWrapEl[0], 'y') || 0;
...
var scrollmain = new locomotive_scroll_esm({
...
var headerScroll = jquery_default()('.header.sticky');
scrollmain.on('scroll', function (instance) {
  if (jquery_default()(window).width() > 992) {
    if (instance.direction == 'up') {
      if (instance.scroll.y > header.outerHeight()) {
    ...
    if (instance.direction == 'up') {
      ...
      if (instance.scroll.y > headerScroll.outerHeight()) {
      ...
      if (instance.scroll.y > headerScroll.outerHeight()) {
        ...
        if (document.querySelector('.header-links-wrap').classList.contains('show') == false) {
          headerScroll.removeClass('show');
        }
      }
    }
...
function pageActive() {
  if (jquery_default()('.homepage').length) {
    jquery_default()("a[data-page='home']").addClass('active');
  } else if (jquery_default()('.aboutpage').length) {
    jquery_default()("a[data-page='about']").addClass('active');
  } else if (jquery_default()('.productpage').length) {
    jquery_default()("a[data-page='product']").addClass('active');
  } else if (jquery_default()('.servicepage').length) {
    jquery_default()("a[data-page='service']").addClass('active');
  } else if (jquery_default()('.contactpage').length) {
    jquery_default()("a[data-page='contact']").addClass('active');
  }
}

;
pageActive();
jquery_default()('.header-menu-toggle').on('click', function () {
  jquery_default()('.header-menu-toggle').toggleClass('show');
  jquery_default()('.header-links-wrap').toggleClass('show');
  jquery_default()('.header.sticky').toggleClass('toggle');
});

function scriptHome() {
  if (jquery_default()('.homepage').length) {
    var initSwiperHero = function initSwiperHero() {
      var swiper = new core_class('.swiper', {
        parallax: true,
        slidesPerView: 1,
        loop: true,
        effect: 'fade',
    ...
    var initSwiperProduct = function initSwiperProduct() {
      var swiper = new core_class('.swiper-product', {
        parallax: true,
        slidesPerView: 2,
        spaceBetween: 20,
        navigation: {
...
function scriptAbout() {
  if (jquery_default()('.aboutpage').length) {
    var dynamicHeight = function dynamicHeight() {
      var height = document.querySelector('.content-static-wrap').offsetHeight + 1;
      document.querySelector('.scheroabout-bg-wrap').setAttribute("style", "height: ".concat(height, "px"));
    };

    var businessAccordion = function businessAccordion() {
      jquery_default()('.business-item').on('click', function (e) {
        jquery_default()('.business-item').removeClass('active');
...
function scriptDetail() {
  if (jquery_default()('.detailpage').length) {
    var dynamicHeight = function dynamicHeight() {
      var height = document.querySelector('.content-descrip-wrap').offsetHeight + 1;
      document.querySelector('.scherodetail-bg-wrap').setAttribute("style", "height: ".concat(height, "px"));
    };
    ...
    jquery_default()('.img-nav').on('click', function (e) {
      e.preventDefault;
      e.stopPropagation;
      var target = jquery_default()(e.target).data('name');
      console.log(target);
      jquery_default()('.img-nav').removeClass('active');
      jquery_default()(this).addClass('active');
      jquery_default()('.img-main').removeClass('active');
...
jquery_default()(window).on('load', function () {
  setTimeout(function () {
    jquery_default()('.loading-wrap').addClass('hidden');
  }, 500);
});
})();
